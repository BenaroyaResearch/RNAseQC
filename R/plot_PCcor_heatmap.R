...
#' @param filename a character string. If provided, the function outputs a pdf of the plot, named "\code{filename}.pdf". If not provided, the function prints to a plotting window.
