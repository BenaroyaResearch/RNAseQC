...
#' @param min_counts the minimum number of counts for a gene to be counted as detected. Genes with sample counts >= this value are considered detected.
...
#' @usage \code{
#' estimate_saturation(counts, max_reads=Inf,
#'                     method="sampling",
#'                     ndepths=6, nreps=5, min_counts=1,
#'                     verbose=FALSE
#'                     )}
estimate_saturation <- function(counts, max_reads=Inf,
                                method="sampling",
                                ndepths=6, nreps=5, min_counts=1,
                                verbose=FALSE) {
